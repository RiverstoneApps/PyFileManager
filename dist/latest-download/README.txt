**********IMPORTANT**********
Please ONLY open the respective files for your Operating System (.exe for Windows, .app for MacOS, LinuxBinary for Linux, RPiBinary for Raspberry Pi), as you will encounter issues trying to open the other files.
